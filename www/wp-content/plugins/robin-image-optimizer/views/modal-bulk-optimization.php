...
<div class="wrio-swal-content">
    <ul class="wrio-list-infos">
        <li>
            ...
            <span><?php _e( 'If you choose to optimize now, you should keep this page open until a bulk optimization is performed. If you leave, the optimization process will stop and you will need to run it again..', 'robin-image-optimizer' ); ?></span>
        </li>
        <li>
            <span class="wrio-info-icon">
