...
$plugin_info = array(
	...
	'load_factory_modules' => array(
		...
		array( 'libs/factory/feedback', 'factory_feedback_110', 'admin' ),
		array( 'libs/factory/logger', 'factory_logger_111', 'all' ),
		array( 'libs/factory/processing', 'factory_processing_100', 'all' ),
	)
);

$wrio_compatibility = new Wbcr_Factory446_Requirements( __FILE__, array_merge( $plugin_info, array(
