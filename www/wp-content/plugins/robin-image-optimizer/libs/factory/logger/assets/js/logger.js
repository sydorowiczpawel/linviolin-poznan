function wbcr_factory_logger_111_LogCleanup(element) {
    ...
    jQuery.ajax({
        ...
        method: 'post',
        data: {
            action: 'wbcr_factory_logger_111_logs_cleanup',
            nonce: wbcr_factory_logger_111.clean_logs_nonce
        },
        success: function (data) {
            ...
            jQuery.wbcr_factory_clearfy_237.app.showNotice(data.message, data.type);
        },
        error: function (jqXHR, textStatus, errorThrown) {
            jQuery.wbcr_factory_clearfy_237.app.showNotice('Error: ' + errorThrown + ', status: ' + textStatus, 'danger');
            btn.html(currentBtnText);
        }
    });
}
